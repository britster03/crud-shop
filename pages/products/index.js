    ...
    return (
        <div className="flex flex-wrap justify-center p-5 gap-4 bg-gray-100">
            ...
            listOfProducts.map(productItem=>
             <div className="w-80 border border-black p-5 rounded-lg shadow-md" key={productItem.id}>
             
            <p className="text-lg font-bold">{productItem.title}</p>
            <div>
            <img className="h-20 mt-3 object-cover" src={productItem.image}></img>
            </div>
            <p className="mx-0 mt-3 font-bold">
